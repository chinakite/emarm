...
public class ProductDao {
    ...
    public List<Product> listLastProducts() {
        ...
        List<Product> products = IdeaJdbc.query(sql)
                ...
                .populate("samples", "sp").listTo(Product.class, "p");
                                            ...
                                            HashMap<String, String> condition)
    {
        ...
        Query query = IdeaJdbc.query(sql).setParameter("userId", userId)
                .setParameter("type", ProductType.TEXT).populate("author", "a")
                .populate("subject", "s");
    ...
    public Long countProductByTime(Date startTime, Date endTime) {
        String sql = "SELECT COUNT(c_id) FROM T_PRODUCT WHERE C_CREATETIME BETWEEN :startTime AND :endTime AND C_STATE <> :state";
        return (Long) IdeaJdbc.query(sql).setParameter("startTime", startTime)
                .setParameter("endTime", endTime)
                .setParameter("state", ProductState.DRAFT).uniqueValue();
    }
